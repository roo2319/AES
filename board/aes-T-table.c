...
void aes_t_box(aes_gf28_t* s){
  aes_gf28_col_t e0 = T0[s[0]] ^ T1[s[5]] ^ T2[s[10]] ^ T3[s[15]];
  aes_gf28_col_t e1 = T0[s[4]] ^ T1[s[9]] ^ T2[s[14]] ^ T3[s[3]];
  aes_gf28_col_t e2 = T0[s[8]] ^ T1[s[13]] ^ T2[s[2]] ^ T3[s[7]];
  aes_gf28_col_t e3 = T0[s[12]] ^ T1[s[1]] ^ T2[s[6]] ^ T3[s[11]];    
  s[0]  = (e0      ) & 0xff; 
  s[1]  = (e0 >> 8 ) & 0xff;
  s[2]  = (e0 >> 16) & 0xff;
  s[3]  = (e0 >> 24) & 0xff;
